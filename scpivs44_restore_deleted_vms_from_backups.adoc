...
.Avant de commencer
* Le compte utilisateur du système de stockage, sur la page systèmes de stockage du client VMware vSphere, doit avoir le link:scpivs44_minimum_ontap_privileges_required.html["Privilèges minimum ONTAP requis pour ONTAP"].
* Le compte utilisateur dans vCenter doit avoir le link:scpivs44_minimum_vcenter_privileges_required.html["Minimum de privilèges vCenter requis pour le plug-in SnapCenter pour VMware vSphere"].
