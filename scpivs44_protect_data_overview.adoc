...
* Si les sauvegardes échouent avec l'erreur `Unable to discover resources on SCV: <xxx>…` pour les machines virtuelles NFS et VMFS après le basculement/retour, redémarrez les services VMware SnapCenter à partir de la console de maintenance.
